...
async function setDistricts () {
  ...
  const districts = [
    ...
    { name: "Bibliothèque", image: "Bibliothèque.jpg", description: "Si vous choisissez de piocher des cartes au début de votre tour, vous en piochez deux et les conservez toutes les deux.", price: 6, type: typeId.prestige },
